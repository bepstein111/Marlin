 ...
 */
  ...
  #define PID_EXTRUSION_SCALING
    ...
    #define DEFAULT_Kc (130) // heating power = Kc * e_speed
...
#define PID_FAN_SCALING
    ...
    //#define PID_FAN_SCALING_ALTERNATIVE_DEFINITION
      ...
      #define PID_FAN_SCALING_AT_FULL_SPEED 60.0        //=PID_FAN_SCALING_LIN_FACTOR*255+DEFAULT_Kf
      #define PID_FAN_SCALING_AT_MIN_SPEED 40.0          //=PID_FAN_SCALING_LIN_FACTOR*PID_FAN_SCALING_MIN_SPEED+DEFAULT_Kf
      #define PID_FAN_SCALING_MIN_SPEED 80.0            // Minimum fan speed at which to enable PID_FAN_SCALING
      ...
      #define DEFAULT_Kf 70.0                              // A constant value added to the PID-tuner
      #define PID_FAN_SCALING_MIN_SPEED 80.0               // Minimum fan speed at which to enable PID_FAN_SCALING
    #endif
  #endif
#endif
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // By default, FAN_PIN is for part-cooling, FAN1_PIN is for the HE heatsink
...
#define SENSORLESS_BACKOFF_MM  { 4, 2 }     // (mm) Backoff from endstops before sensorless homing
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_100X_STEPS_PER_SEC  99999  // (steps/s) Encoder rate for 100x speed
#endif
...
#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_WHITE      100  // User defined WHITE value
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_ABORT "G27"         // G-code to run on Stop Print (e.g., "G28XY" or "G27")
    ...
    #define PE_LEDS_COMPLETED_TIME  (15*60) // (seconds) Time to keep the LED "done" color before restoring normal illumination
  #endif
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_2 "Fade, Save & Activate UBL"
  #define USER_GCODE_2 "G29 F10\nG29 S0\nG29 S1\nG29 A"
